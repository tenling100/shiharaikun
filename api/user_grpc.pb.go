...
type UserServiceClient interface {
	...
	GetUserById(ctx context.Context, in *GetUserIdRequest, opts ...grpc.CallOption) (*UserResponse, error)
...
func (c *userServiceClient) GetUserById(ctx context.Context, in *GetUserIdRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserResponse)
...
type UserServiceServer interface {
	...
	GetUserById(context.Context, *GetUserIdRequest) (*UserResponse, error)
...
func (UnimplementedUserServiceServer) GetUserById(context.Context, *GetUserIdRequest) (*UserResponse, error) {
...
func _UserService_GetUserById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetUserById(ctx, req.(*GetUserIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
